...
describe Player do
  ...
  context 'setting the name for the player' do
    describe '#name' do
      it 'should not raise an error' do
        expect { player.name = 'some name' }.not_to raise_error
      end
    end
  end
  ...
  context 'getting the name of the player' do
    describe '#name' do
      it 'should not raise an error' do
        expect { player.name }.not_to raise_error
      end
    end
  end
  ...
  context 'setting the symbol of the player' do
    describe '#symbol' do
      it 'should not raise an error' do
        expect { player.symbol = :x }.not_to raise_error
      end
    end
  end
  ...
  context 'getting the symbol of the player' do
    describe '#symbol' do
      it 'should not raise an error' do
        expect { player.symbol }.not_to raise_error
      end
    end
  end
end
